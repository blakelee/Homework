...
class HomeworkAdapter(val bg_color: Int): BaseAdapter<Homework, HomeworkAdapter.HomeworkViewHolder>() {

    override fun getItemViewId(): Int = 0

    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): HomeworkViewHolder =
        HomeworkViewHolder(AssignmentItemUI().createView(AnkoContext.create(parent!!.context, parent)), bg_color)

    override fun instantiateViewHolder(view: View?): HomeworkViewHolder =
        HomeworkViewHolder(view, bg_color)

    class HomeworkViewHolder(itemView: View?, val bg_color: Int) : BaseViewHolder<Homework>(itemView) {
